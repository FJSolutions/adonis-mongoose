...
export class AdonisMongoose {
   ...
   */
  public add (name: string, mongoose: Mongoose.Connection, setAsDefaultConnection = false) : Mongoose.Connection {
   ...
   */
  public model<T extends Mongoose.Document> (name: string, schema: Mongoose.Schema, collectionName?: string) : Mongoose.Model<T> {
